        ...
        if (cloudCarModelEntities.size() > 0) {
            for (CloudCarModelEntity cloudCarModelEntity : cloudCarModelEntities) {
                ...
                JDBC_TEMPLATE.query(condition, rs -> {
                    ...
                    String panoramicCamera= rs.getString("panoramic_camera");
                    String rearParkingAid= rs.getString("rear_parking_aid");
                    String telematics= rs.getString("telematics");
                    String valveSystem= rs.getString("valve_system");
                    String cylinderHead= rs.getString("cylinder_head");
                    String cylinderBlock= rs.getString("cylinder_block");
                    String bodyStructure= rs.getString("body_structure");
                    String parkingBrake= rs.getString("parking_brake");
                    String warrantyPeriod= rs.getString("warranty_period");
                    String vehicleColor= rs.getString("vehicle_color");
                    String intelligentStopStart= rs.getString("intelligent_stop_start");
                    String dippedLights= rs.getString("dipped_lights");
                    String highBeam= rs.getString("high_beam");
                    String maintenanceRemark= rs.getString("maintenance_remark");

                    cloudCarModelEntity.setTelematics(telematics);
                    cloudCarModelEntity.setValveSystem(valveSystem);
                    cloudCarModelEntity.setCylinderHead(cylinderHead);
                    cloudCarModelEntity.setCylinderBlock(cylinderBlock);
                    cloudCarModelEntity.setBodyStructure(bodyStructure);
                    cloudCarModelEntity.setParkingBrake(parkingBrake);
                    cloudCarModelEntity.setWarrantyPeriod(warrantyPeriod);
                    cloudCarModelEntity.setVehicleColor(vehicleColor);
                    cloudCarModelEntity.setIntelligentStopStart(intelligentStopStart);
                    cloudCarModelEntity.setDippedLights(dippedLights);
                    cloudCarModelEntity.setHighBeam(highBeam);
                    cloudCarModelEntity.setMaintenanceRemark(maintenanceRemark);
                    ...
                    cloudCarModelEntity.setACC(acc);
                    cloudCarModelEntity.setPanoramicCamera(panoramicCamera);
                    cloudCarModelEntity.setRearParkingAid(rearParkingAid);
