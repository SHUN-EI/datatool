...
import com.ys.datatool.domain.entity.CloudCarModelEntity;
...
public class CloudCarService {
    ...
    public void testData() {
        ...
        System.out.println("ids结果为" + ids.size());
    }

    @Test
    public void fetchVinOnetoThreeBrandData() throws Exception {
        List<String> manufacturers = new ArrayList<>();
        List<CloudCarModelEntity> cloudCarModelEntities = new ArrayList<>();

        String query = "select  distinct  manufacturers from  sm_cloud_car_model_all ;";
        String queryByManufacturer = "select * from sm_cloud_car_model_all where manufacturers=";

        //力洋数据中所有厂家
        JDBC_TEMPLATE.query(query, rs -> {
            while (rs.next()) {
                String manufacturer = rs.getString("manufacturers");
            ...
            for (int i = 158; i < manufacturers.size(); i++) {
                ...
                JDBC_TEMPLATE.query(condition, rs -> {
                    while (rs.next()) {
                        ...
                        cloudCarModelEntity.setManufacturers(manufacturer);
        ...
        System.out.println("结果为" + manufacturers.toString());
        System.out.println("结果为" + manufacturers.size());
    ...
    public void fetchMatchVINLevelIdData() throws Exception {
        ...
        String query = "select * from  sm_cloud_car_model_all ;";
    ...
    private void fetchVINFromMongo(List<CloudCarModelEntity> cloudCarModelEntities) {
